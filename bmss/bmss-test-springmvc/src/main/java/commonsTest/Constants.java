...
public class Constants {
    ...
    public final static String ZOO_HOSTS_URL_ZK_KEY = "zkKey";
    ...
    public final static String ZK_SUPER_ADMIN="super:1qazZXC";
    
    public final static String COMMON_APP="common-app";
    
    public final static String CLIENT_LECONF_FILE_NAME="leconf.properties";
