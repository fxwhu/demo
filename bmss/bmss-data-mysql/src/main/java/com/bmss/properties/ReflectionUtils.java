...
public class ReflectionUtils {
    ...
    public void getBasicType(Class<?> clazz, final String fieldName){
        Field[] declaredFields = clazz.getDeclaredFields();
        for (Field field: declaredFields){
            String typeName = field.getType().getName();
            List<String> basicType = Lists.newArrayList("int", "long", "boolean", "double");
            if(!basicType.contains(typeName)){
                getBasicType(field.getType(), fieldName);
            }
            field.getName();
            System.out.println("========");
        }
    ...
    public static Field newGetAccessibleField(final Object obj, final String fieldName) {
        Assert.notNull(obj, "object不能为空");
        Assert.hasText(fieldName, "fieldName");
        for (Class<?> superClass = obj.getClass();
             superClass != Object.class; superClass = superClass.getSuperclass()) {
